export const dom = {
  ...
  dashboardWrap: document.querySelector('[data-ui="dashboard-wrap"]'),
  diagnosisWrap: document.querySelector('[data-ui="diagnosis-wrap"]'),
  ...
  openAnalysisButton: document.querySelector('[data-action="open-analysis"]'),
  openDiagnosisButton: document.querySelector('[data-action="open-diagnosis"]'),
  ...
  closeDashboardButton: document.querySelector('[data-action="close-dashboard"]'),
  closeDiagnosisButton: document.querySelector('[data-action="close-diagnosis"]'),
